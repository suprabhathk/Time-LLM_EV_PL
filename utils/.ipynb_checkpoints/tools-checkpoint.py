...
def visual_loss(train_loss, vali_loss, path, test_loss=None):
    """
    Saves a plot of the training, validation, and optional test loss over epochs.
    """
    ...
    # Check if test_loss was provided and add it to the plot
    ...
    import os # Ensure os is imported inside the function or at the top of tools.py
