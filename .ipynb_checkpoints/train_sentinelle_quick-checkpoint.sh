...
# =============================================================================
# FRENCH ILI FORECASTING TRAINING SCRIPT - QUICK VERSION
# =============================================================================
# Trains TimeLLM models for French ILI data (Réseau Sentinelles 1984-2025)
# Quick version: Only 2 & 4 week forecasts, reduced epochs for fast iteration
# =============================================================================

echo "=========================================="
echo "FRENCH ILI FORECASTING - QUICK TRAINING"
...
# Model architecture (SAME as train_sentinelle_ILI.sh)
LLM_MODEL="GEMMA"
LLM_DIM=640
LLM_LAYERS=12
D_MODEL=32
...
TRAIN_EPOCHS=20        # REDUCED from 50 for quick testing
...
echo "  Epochs: $TRAIN_EPOCHS (QUICK MODE)"
echo ""

# =============================================================================
# Train models for multiple prediction horizons (QUICK: only 2 & 4 weeks)
# =============================================================================

HORIZONS=(2 4)  # Only 2 and 4 week forecasts for quick iteration
...
for PRED_LEN in "${HORIZONS[@]}"; do
    ...
    python run_main.py \
        ...
        --data_path "$DATA_PATH" \
        --model_id "$MODEL_ID" \
        --model_comment "French ILI quick forecast $PRED_LEN weeks ahead" \
        --model TimeLLM \
        --data "$DATA_NAME" \
        --features "$FEATURES" \
        --target "$TARGET" \
...
echo "=========================================="
echo "[OK] ALL QUICK MODELS TRAINED SUCCESSFULLY"
echo "=========================================="
echo ""
echo "Checkpoints saved to:"
echo "  ./checkpoints/long_term_forecast_sentinelle_ILI_quick_2week_*/"
echo "  ./checkpoints/long_term_forecast_sentinelle_ILI_quick_4week_*/"
echo ""
