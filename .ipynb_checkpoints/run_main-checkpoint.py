...
for ii in range(args.itr):
    ...
    for epoch in range(args.train_epochs):
        ...
        train_loss_history.append(train_loss) # New stuff
        vali_loss_history.append(vali_loss) # New stuff
        test_loss_history.append(test_loss) # <--- ADD THIS
        accelerator.print(
        ...
        if accelerator.is_local_main_process:
            ...
            visual_loss(train_loss_history, vali_loss_history, path, test_loss_history) # <--- New Stuff
